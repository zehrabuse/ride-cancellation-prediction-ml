...
## Purpose
This notebook (`RDP_Exploratory_Data_Analysis.ipynb`) provides a comprehensive exploratory analysis of the ride cancellation dataset. The goal is to identify patterns, trends, and key features influencing cancellations, which will guide subsequent feature engineering and predictive modeling.

## Notebook
You can view and run the notebook here:  [RDP_Exploratory_Data_Analysis.ipynb](../notebooks/RDP_Exploratory_Data_Analysis.ipynb)
